...
function About() {
	...
	const imageLinks = [
		...
		// "https://celebmix.com/wp-content/uploads/2021/07/interview-tessa-violet-talks-games-ft.-lovelytheband-01.jpg" //gold outfit
	];
	useEffect(() => {
		const cycle = () => {
	...
	return (
		<>
			<img src={imageLinks[imageCounter]} className="cover-image" alt="Tessa Violet" />
			<Bio />
		</>
	);
}
